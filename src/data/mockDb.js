...
export const candidates = Array.from({ length: 56 }, (_, i) => {
  ...
  return {
    ...
    headline: pick(['Senior Frontend Engineer','Product Designer','Data Analyst','HR Manager','Sales Executive','Full-stack Developer','Marketing Specialist','Customer Success Lead','Java Backend Engineer','iOS Engineer']),
    location: pick(LOCATIONS),
    totalExperienceYears: Math.floor(rand() * 18),
    skills: skillSet,
